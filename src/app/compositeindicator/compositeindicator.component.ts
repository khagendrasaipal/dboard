...
import { CompositeIndicatorService } from './compositeindicator.service';

@Component({
  selector: 'app-compositeindicator',
  templateUrl: './compositeindicator.component.html',
  styleUrls: ['./compositeindicator.component.scss']
})
export class CompositeIndicatorComponent implements OnInit {
  ...
  constructor(private RS: CompositeIndicatorService, private toastr: ToastrService, private fb: FormBuilder) { 
